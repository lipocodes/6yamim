...
//upload the images to Firebase Storage
  ...
  retrieveSubcategories() async {
    ...
    this.dropDownCategory2 = buildAndGetDropDownItems(this.categoryLevel2);
    ...
    this.categoryLevel3 = list;
    this.dropDownCategory3 = buildAndGetDropDownItems(this.categoryLevel3);
